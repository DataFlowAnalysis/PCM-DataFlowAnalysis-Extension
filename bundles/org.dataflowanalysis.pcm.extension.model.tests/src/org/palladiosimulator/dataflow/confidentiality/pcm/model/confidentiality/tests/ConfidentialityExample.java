...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>confidentiality</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfidentialityExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ConfidentialityPackage.eNS_URI, 
			 ConfidentialityPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.confidentiality"));
				ConfidentialityVariableCharacterisation root = ConfidentialityFactory.eINSTANCE.createConfidentialityVariableCharacterisation();
