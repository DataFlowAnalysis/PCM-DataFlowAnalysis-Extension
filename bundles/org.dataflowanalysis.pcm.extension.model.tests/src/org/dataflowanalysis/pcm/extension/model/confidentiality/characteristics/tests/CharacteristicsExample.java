...
import org.dataflowanalysis.pcm.extension.model.confidentiality.characteristics.CharacteristicsPackage;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>characteristics</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CharacteristicsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(CharacteristicsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.characteristics"));
				CharacteristicTypeDictionary root = CharacteristicsFactory.eINSTANCE.createCharacteristicTypeDictionary();
