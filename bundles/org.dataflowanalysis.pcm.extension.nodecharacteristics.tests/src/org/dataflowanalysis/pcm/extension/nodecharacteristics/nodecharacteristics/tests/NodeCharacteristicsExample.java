...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>nodecharacteristics</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeCharacteristicsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(NodeCharacteristicsPackage.eNS_URI, 
			 NodeCharacteristicsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.nodecharacteristics"));
				UsageAsignee root = NodeCharacteristicsFactory.eINSTANCE.createUsageAsignee();
